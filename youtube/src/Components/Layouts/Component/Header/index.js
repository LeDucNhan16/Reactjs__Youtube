...
const MENU_ITEMS = [
  ...
  },
  {
    ...
    iconsub: <RightArrowIcon />,
    children: {
      title: "Add Accounts",
      data: [
        {
          icon: <AddAccountsIcon />,
          title: "Add Accounts",
        },
        {
          icon: <SignOutIcon />,
  ...
  },
  {
    ...
    to: "https://myaccount.google.com/u/0/yourdata/youtube?hl=en",
  },
  {
    icon: <AppearenceIcon />,
    title: "Appearance",
  ...
  },
  {
    ...
    children: {
      ...
      data: [
        ...
        {
          title: "Activate Restricted Mode",
          id: "3",
        },
      ],
    },
  ...
  },
  {
    ...
    children: {
      ...
      data: [
        ...
        {
          title: "Toggle miniplayer : i ",
          id: "3",
        },
        {
          title: "Close miniplayer  : ESCAPE",
          id: "4",
        },
        {
          title: "Toggle mute : m",
  ...
  return (
    <div className={cx("wrapper")}>
      ...
      <Link to={config.router.Home}>
        {/* <button className={cx("header__bars")}>
          <BarsIcon />
        </button> */}
        <svg className={cx("logo__header")}>
          <g>
            <path
      ...
      {currentResult ? (
        <div className={cx("account")}>
          <Tippy
            ...
            hideOnClick={false}
          >
            <button className={cx("video__icon")}>
              <VideoIcon />
            </button>
          </Tippy>
          <Tippy
        ...
        <div className={cx("account")}>
          <Tippy
            ...
            hideOnClick={false}
          >
            <button className={cx("use__icon")}>
              <ListIcon />
            </button>
          </Tippy>
          <Button primary>
            <YourIcon className={cx("icon__login")} />
            Login
          </Button>
        </div>
      )}
